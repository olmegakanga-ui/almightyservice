      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '14px', background: 'rgba(255,255,255,0.04)', borderRadius: '12px' }}>
            <p style={{ fontSize: '0.65rem', letterSpacing: '0.2em', color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', marginBottom: '4px' }}>
              Table
            </p>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '14px', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.06)' }}>
          <p style={{ fontSize: '0.6rem', letterSpacing: '0.2em', color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', marginBottom: '4px' }}>
            Table
          </p>
