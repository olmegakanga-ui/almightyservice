  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Badge deadline dynamique */}
        {deadline && status === 'pending' && !isPastDeadline && (
          <div
            style={{
              display:      'inline-flex',
              alignItems:   'center',
              ...
              border: days <= 3
                ? '1px solid rgba(184,80,96,0.3)'
                : '1px solid rgba(255,255,255,0.08)',
              marginBottom: '48px',
            }}
          >
            <Clock size={13} color={days <= 3 ? '#E89AA6' : 'var(--gold)'} />
            <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.8rem' }}>
              Date limite :{' '}
              <span style={{ color: days <= 3 ? '#E89AA6' : 'var(--gold-light)' }}>
        ...
        {deadline && status === 'pending' && isPastDeadline && (
          ...
          >
            <Clock size={13} color="#E89AA6" />
            <span style={{ color: '#E89AA6', fontSize: '0.8rem' }}>
              Date limite dépassée — {formatDeadline(deadline)}
            </span>
          </div>
        )}
        ...
        {status === 'confirmed' && (
          <div style={{
            ...
            <p className="font-display" style={{ fontSize: '1.6rem', color: '#7EC89A', marginBottom: '8px' }}>
              Présence confirmée
            </p>
        ...
        {status === 'declined' && (
          <div style={{
            ...
            <p className="font-display" style={{ fontSize: '1.6rem', color: '#E89AA6', marginBottom: '8px' }}>
              Invitation déclinée
            </p>
            <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem' }}>
              Vous nous manquerez.
