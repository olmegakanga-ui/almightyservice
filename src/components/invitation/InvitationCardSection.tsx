...
export default function InvitationCardSection({ event, guest }: Props) {
  ...
  return (
    ...
    >
      {/* Fond semi-transparent pour renforcer la lisibilité */}
      <div style={{
        position:     'absolute',
        inset:        0,
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <p className="label-overline" style={{ marginBottom: '24px', opacity: 0.9 }}>
              Invitation
            </p>
          ...
          >
            ...
            <p className="label-overline" style={{ marginBottom: '40px', opacity: 0.9 }}>
              Programme du jour
            </p>
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: 'rgba(255,255,255,0.95)', fontSize: '0.9rem', fontWeight: 500 }}>
                  {event.venueName}
                </p>
                <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: '0.8rem', marginTop: '2px' }}>
                  {event.venueAddress}
                </p>
              </div>
            </div>
